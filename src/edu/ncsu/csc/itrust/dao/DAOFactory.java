...
public class DAOFactory {
	 ...
	 * @return this DAOFactory's HealthRecordsDAO
	 */
	public ObstetricRecordsDAO getObstetricRecordsDAO() {
		return new ObstetricRecordsDAO(this);
	}
	...
	public PregnanciesDAO getPregnancyDAO() {
		return new PregnanciesDAO(this);
	}
}
