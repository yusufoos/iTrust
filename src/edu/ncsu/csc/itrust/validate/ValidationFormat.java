...
public enum ValidationFormat {
	...
	DELIVERYTYPE("(Vaginal Delivery)|(Caesarean Section)|(Miscarriage)", "Only One of “Vaginal Delivery”, “Caesarean Section”, or “Miscarriage”"),
	NOTES("[a-zA-Z0-9\\s'\"?!:#;\\-.,_\n\t]{1,300}",
	...
	WEEKANDDAYS("[\\d]{2,3}", "2 to 3 digits"),
