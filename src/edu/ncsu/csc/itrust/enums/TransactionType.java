...
public enum TransactionType {
	...
	/**HCP_VIEW_OBSTETRIC_RECORDS*/
	HCP_VIEW_OBSTETRIC_RECORDS(6301, "HCP View of Obstetric Records", "viewed your obstetric records history", true),	
	/**HCP_CREATE_OBSTETRIC_RECORD*/
	HCP_CREATE_OBSTETRIC_RECORD(6300, "HCP created Obstetric Record", "created your obstetric record", true),	
