...
CREATE TABLE pregnancies (
	...
	PatientID BIGINT unsigned NOT NULL default '0',
	YearOfConception BIGINT unsigned NOT NULL default '0',
	NumberOfWeeksPregnant BIGINT unsigned NOT NULL default '0',
	NumberOfHoursInLabor DOUBLE,
	DeliveryType VARCHAR(50) NOT NULL
) ENGINE=MyISAM;

CREATE TABLE obstetricrecords (
    id BIGINT unsigned AUTO_INCREMENT primary key,
	PatientID BIGINT unsigned NOT NULL default '0',
	HCPID BIGINT unsigned default NULL,  
	LMP VARCHAR(15) NOT NULL default '00/00/0000',
	dateRecorded date NOT NULL default '0000-00-00'
) ENGINE=MyISAM;
